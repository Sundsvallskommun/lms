...
require_capability('enrol/waitlistext:config', $context);



$PAGE->set_url('/enrol/waitlistext/edit.php', array('courseid' => $course->id, 'id' => $instanceid));
...
if (!enrol_is_enabled('waitlistext')) {
...
$plugin = enrol_get_plugin('waitlistext');



if ($instanceid) {
    $instance = $DB->get_record('enrol', array('courseid' => $course->id, 'enrol' => 'waitlistext', 'id' => $instanceid), '*', MUST_EXIST);
} else {
...
if ($mform->is_cancelled()) {
	...
	$instance->roleid         = $data->roleid;
        ...
        $properties2 = get_object_vars($instance);
        ...
        $fields = array('status' => $data->status, 'name' => $data->name, 'password' => $data->password, 'customint1' => $data->customint1, 'customint2' => $data->customint2,
                        ...
                        'customint3' => $data->customint3, 'customint4' => $data->customint4, 'customint5' => $data->customint5, 'customint6' => $data->customint6, 'customint7' => $data->customint7, 'customint8' => $data->customint8,'customtext1' => $data->customtext1, 'customtext2' => $data->customtext2,'customtext3' => $data->customtext3,
