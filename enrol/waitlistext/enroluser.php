...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'waitlistext'), '*', MUST_EXIST);
...
if (!$enrol_manual = enrol_get_plugin('waitlistext')) {
    throw new coding_exception('Can not instantiate enrol_manual');
}

$instancename = $enrol_manual->get_instance_name($instance);

$PAGE->set_url('/enrol/waitlistext/enroluser.php', array('enrolid' => $instance->id));
