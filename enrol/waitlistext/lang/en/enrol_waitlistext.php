...
$string['toenrol_section_pre'] = 'Your not in this section:';
...
$string['section'] = 'Default value for section';
$string['section_help'] = 'Sets the default value this will have inside the waitlist plugin';
$string['section_req'] = 'Section to work in to enrol to course';
$string['label_section'] = 'Required department';
...
$string['label_section_chosen'] = 'The required Section';
